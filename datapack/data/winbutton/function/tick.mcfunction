...
execute as @a[scores={give_button=1..},gamemode=!creative] run tellraw @s {translate:"tellraw.winbutton.give_button.success",fallback:"Only creative mode players can use this command!",color:"red"}

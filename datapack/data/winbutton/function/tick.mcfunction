...
execute as @a[scores={give_button=1..},gamemode=creative] run tellraw @a [{selector: "@a[scores={give_button=1..},gamemode=creative]", },{text: "just gave themselves a Win Button!"}]
